...
import (
	...
	endpoint "github.com/gSchool/classExMay23/users/pkg/endpoint"
	http "github.com/gSchool/classExMay23/users/pkg/http"
...
var grpcAddr = fs.String("grpc-addr", ":9002", "gRPC listen address")
var thriftAddr = fs.String("thrift-addr", ":9003", "Thrift listen address")
